import {enhancePlayerMedia} from './player-media.js?v=ui-polish-5';
import {esc} from './components.js?v=ui-polish-5';
import {layoutPage} from './page-layout.js?v=highlights-1';
const routes=[['/command-center/','Home','home'],['/builder/','Lineup Builder','grid'],['/lineups/','Recommended Lineups','star'],['/research/','Research','chart'],['/leaderboard/','Leaderboard','star'],['/preview/','Player Props','chart'],['/drive-lab/','Drive Lab','play'],['/simulation/','Simulation Station','activity'],['/newsroom/','Injuries & News','news'],['/research/calibration/','Analytics','chart'],['/saved/','Saved Lineups','save'],['/settings/','Settings','settings']];
const descriptions={'Research':'Discover, investigate & compare','Leaderboard':'Weekly fantasy finishes','Home':'Your slate at a glance','Lineup Builder':'Choose players & optimize','Recommended Lineups':'Ready-made lineup ideas','Player Props':'Compare lines & player form','Drive Lab':'Explore game matchups','Simulation Station':'See player outcome ranges','Injuries & News':'Availability & team updates','Analytics':'Track model performance','Saved Lineups':'Your lineups & scenarios','Settings':'Display & preferences'};
