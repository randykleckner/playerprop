...
import {layoutPage} from './page-layout.js?v=ui-redesign-2';
...
export function mountShell(){
 ...
 if(new URLSearchParams(location.search).has('embed')){document.body.classList.add('ui-embedded');const style=document.createElement('link');style.rel='stylesheet';style.href='/ui/redesign.css?v=ui-redesign-2';document.head.append(style);return;}
 const link=document.createElement('link');link.rel='stylesheet';link.href='/ui/workspace.css?v=ui-redesign-2';document.head.append(link);
 const redesign=document.createElement('link');redesign.rel='stylesheet';redesign.href='/ui/redesign.css?v=ui-redesign-2';document.head.append(redesign);
